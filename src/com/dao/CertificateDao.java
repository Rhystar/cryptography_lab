...
public class CertificateDao {
    ...
    public List<CertItem> getAllCer() {
        List<CertItem> certificates =
            template.query("SELECT * FROM certificate", new BeanPropertyRowMapper<CertItem>(CertItem.class));
        return certificates;
    }
    ...
    public List<CertItem> getCerByPage(Page page) {
        List<CertItem> certificates = template.query(
